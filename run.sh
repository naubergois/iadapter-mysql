...
mysql -u root -e " CREATE TABLE workspace.Operation (NAME varchar(345) DEFAULT NULL,  testplan varchar(245) DEFAULT NULL,  FUNC integer DEFAULT NULL, NEWFUNC integer DEFAULT NULL, IDOLDWORKLOAD integer DEFAULT NULL,  id int(11) NOT NULL AUTO_INCREMENT,  state varchar(300) DEFAULT NULL,  PRIMARY KEY (id)) ENGINE=InnoDB AUTO_INCREMENT=34075 DEFAULT CHARSET=latin1; "
